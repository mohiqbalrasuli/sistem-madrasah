...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('vendor/assets/Screenshot_2025-03-22_002912-removebg-preview.png') }}"
        type="image/x-icon" />
...
<body>
    ...
    <div class="container">
        ...
        <div class="sidebar" id="sidebar">
            <div class="cardlogo">
                <img src="{{ asset('vendor/assets/Screenshot_2025-03-22_002912-removebg-preview.png') }}"
                    alt="Logo MDT Al-Barokah" width="60px" height="60px" />
                <div class="name">
                    <h3>SISTEM</h3>
            ...
            <nav>
                ...
                <a href="/data-guru" onclick="closeSidebarOnMobile()"><i class="fas fa-chalkboard-teacher"></i> Data
                    Guru</a>
                <a href="/data-murid" onclick="closeSidebarOnMobile()"><i class="fas fa-user-graduate"></i> Data Murid
                </a>
                <a href="/data-kelas" onclick="closeSidebarOnMobile()"><i class="fas fa-school"></i> Data Kelas </a>
                <div class="nilai-submenu">
                    <a href="#" onclick="toggleNilaiMenu(event)"><i class="fas fa-star"></i> Data Nilai <i
                ...
                <a href="/data-fan" onclick="closeSidenarOnmobile(event)"><i class="fas fa-book"></i> Data Fan </a>
                <a href="/jadwal-pelajaran" onclick="closeSidebarOnMobile()"><i class="fas fa-calendar"></i> Jadwal
                    Pelajaran</a>
                <a href="/data-alumni" onclick="closeSidenarOnmobile(event)"><i class="fas fa-user-graduate"></i> Data
                    Alumni </a>
                <a href="/setting" onclick="closeSidenarOnmobile(event)"><i class="fas fa-cog"></i> Pengaturan </a>
            </nav>
        </div>
        <!-- main content -->
            ...
            <div class="main-content">
                <div class="header">
                    ...
                    <div class="theme-admin">
                        <a href="/pengajar/{id}" class="theme-switch" title="Buka Sistem Pengajar" style="color: gray;">
                ...
                <footer class="footer" style="padding: 20px 0; text-align: center; bottom: 0; width: 100%;">
                    <div class="copyright">
                        <p style="margin: 0; color: #6c757d; font-size: 14px;">Copyright © Designed &amp; Developed by
                            Moh. Iqbal Rasuli 2025</p>
                    </div>
                </footer>
            </div>
        </div>
