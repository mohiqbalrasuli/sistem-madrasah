...
<body>
    ...
    <div class="container">
        <div class="sidebar" id="sidebar">
            ...
            <nav>
                <a href="/pengajar/{id}" onclick="closeSidebarOnMobile()">
                ...
                <a href="/jadwal-mengajar/{id}" onclick="closeSidebarOnMobile()">
                    <i class="fas fa-book"></i> Jadwal Mengajar
                </a>
                <a href="http://wa.me/qr/YJQ6XP5FEEAKK1" onclick="closeSidebarOnMobile">
        ...
        <div class="content" id="content">
            <div class="header">
                <div class="theme-admin">
                    ...
                    <div class="admin">
                        <img src="{{ asset('vendor/assets/download.jpeg') }}" alt="Profile" />
